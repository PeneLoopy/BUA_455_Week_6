---
title: "BUA 455 - Week 6"

subtitle: "Reshaping Cleaning and Joining Data"  
...
- I hope that all quizzes will be graded by this weekend or early next week.

<br>

### HW 4 is posted and is due next week on Wednesday, 10/11/23.
...
### Week 6 In-class Exercises (L10 - Q1)
...
### Week 6 In-class Exercises (L10 - Q2)
...
```{r  echo=F, out.height=400, out.width=600, out.extra='style="background-color: #3D3D3D; padding:2px;"'}

knitr::include_graphics("docs_files/images/LinePlot_HW4_Penelope_Pooler_slides.png")
