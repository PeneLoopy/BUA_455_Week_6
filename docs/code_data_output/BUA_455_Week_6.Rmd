...
- There are two student who will make-up Quiz 1 because of absences for legitimate documented reasons.

- Grading is in progress, but can not be discussed until all students have completed their quiz.

- I hope that the course TAs and I will have all quizzes graded by next week.

<br>

### Reminder: No class on Thursday, 10/6/22

### HW 4 is posted and is due next week on Wednesday, 10/12/22.

- Demo Videos will be posted on Friday, 10/7/22

- Grace period may be extended a few days if needed.

- I will be out of town and not available by email from Friday, 10/14, to Sunday, 10/16.
...
### Week 6 In-class Exercises (TP L10 - Q1)
...
### Week 6 In-class Exercises (TP L10 - Q2)

***TurningPoint Session ID: bua455s22***

The end result of any function is an output, e.g. a value, a dataset, a vector, etc.

What happens if you use Option 2 where you save work to an object, `d_out`, but you don't end the function with that object name?

**In-class Demo:** Edit the Option 2 function by removing the `d_out` at the end to see what happens.
...
**You may submit an 'Engagement Question or Comment' about Week 6 lectures until Tuesday, 10/4, at midnight on Blackboard.**
